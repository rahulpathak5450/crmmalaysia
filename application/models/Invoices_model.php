...
class Invoices_model extends CI_Model
{
    ...
    {
        $this->db->select('geopos_invoices.id,geopos_invoices.invNotes,geopos_invoices.tid,geopos_invoices.invoicedate,geopos_invoices.invoiceduedate,geopos_invoices.total,geopos_invoices.status,geopos_invoices.paymentStatus,geopos_customers.name');
        $this->db->from($this->table);
