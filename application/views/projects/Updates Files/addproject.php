        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <div class="form-group row border-blue-grey rounded" ">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4 border-blue-grey rounded""><label class="control-label"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 border-blue-grey rounded""><label class="col col-form-label"
                        ...
                        <div class="col-md-4   border-blue rounded "><label class="col-form-label"
                            ...
                            <input type="text" placeholder="Phase A,B,C"
                                   class="form-control mb-1  " name="phase">
                        </div>
                    </div>
